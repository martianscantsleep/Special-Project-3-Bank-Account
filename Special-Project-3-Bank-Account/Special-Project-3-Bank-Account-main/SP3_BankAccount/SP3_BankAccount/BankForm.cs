namespace SP3_BankAccount
{
    public partial class BankForm : Form
    {
        ...
        private string currentMode = "Transaction";
        ...
        private void depositButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if (currentMode == "Transaction")
                {
                    ...
                    if ((int) currentAccount.GetBalance() > savingsProgress.Maximum) // Check if exceeds maximum value
                    {
                        savingsProgress.Maximum = (int) currentAccount.GetBalance();
                    }
                    savingsProgress.Value = (int) currentAccount.GetBalance();
                ...
                {
                    currentAccount.SetGoal(depositAmount);
                    savingsProgress.Maximum = (int) currentAccount.GetGoal(); //Update savingsGoal on graphic.
                }
                savingsLabel.Text = $"Savings Progress: ${currentAccount.GetBalance()}/${currentAccount.GetGoal()}"; //Update progress label.
            }
        }
        ...
        private void SavingsButton_Click(object sender, EventArgs e)
        {
            ...
            {
                currentMode = "Savings";
                amountLabel.Text = "Enter Goal:";
                SavingsButton.Text = "Transaction";
                depositButton.Text = "Set Goal";
                mobileBankingImage.Visible = false;
                savingsProgress.Visible = true;
            ...
            else
            {
                ...
                mobileBankingImage.Visible = true;
